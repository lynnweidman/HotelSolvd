...
public abstract class RestaurantEmployee implements CurrentYear, SalaryIncrease, GreatPlaceToWork {
    ...
    public static ArrayList<RestaurantEmployee> allRestaurantEmployees = new ArrayList<>();
